...
{
    public class Division : ExpresionBinaria
    {
        ...
        public override void checkTipo(TablaSimbolos tabla)
        {
            if (!expr1.Tipo_Expr.Equals(NucleoLenguaje.tipoEntero) ||
               !expr2.Tipo_Expr.Equals(NucleoLenguaje.tipoEntero))
                SemantErrorReport.Instancia.semantError(this, "la operación de división no se puede aplicar a valores de tipo " + expr1.Tipo_Expr + " y " + expr2.Tipo_Expr);
